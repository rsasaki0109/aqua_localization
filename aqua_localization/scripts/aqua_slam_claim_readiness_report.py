    ...
    lines.extend(
        [
            ...
            *command_block(claim_gate_command(args)),
            ...
            f"- Min target samples: `{args.min_target_samples}`",
            f"- Min target matched seconds: `{args.min_target_matched_s}`",
            f"- Min DVL coverage ratio: `{args.min_dvl_coverage_ratio}`",
            f"- Min prior-applied ratio: `{args.min_prior_applied_ratio}`",
            f"- Min prior-match confidence: `{args.min_prior_match_confidence}`",
            f"- Min applied-prior confidence: `{args.min_applied_prior_confidence}`",
            "",
