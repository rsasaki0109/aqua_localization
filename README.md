...
Both thumbnails are regenerated by [`plot_trajectories.py`](aqua_localization/scripts/plot_trajectories.py)
from recorded TUM trajectories. Demo command shapes are below.
