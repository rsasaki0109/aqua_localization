...
- Artifacts: `datasets/mbes_slam_beach_pond_acquisition.md`, `docs/benchmarks/mbes_beach_pond_loop_status.md`, `run_mbes_loop_benchmark.sh`, `readiness report`, `rerun export`, `RViz loop markers`, `mbes_loop_status.csv`, `descriptor sweep report`, `consistency sweep report`, `consistency rejection audit`, `accepted-loop audit report`, `accepted-loop geometry review`, `high-priority accepted-loop audit packet`
