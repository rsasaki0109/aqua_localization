...
| Tank Dataset | `short_test` | `aqua_localization+visual` | SE(3) | 5400 | 14.95 | 0.2175 | visual warmup, base-frame visual odometry, 700 ORB features, replay rate 1.0, visual coverage 300/300 |
